<?php
// app/templates/my_courses_graph.php
?>

<div class="p-6 bg-white rounded-lg shadow-sm">
    <h2 class="text-2xl font-semibold text-indigo-700 mb-4">My Courses Dependency Graph</h2>
    <p class="text-gray-600 mb-4">This graph shows the dependencies between your manually added courses. Click on a course node for more details. Drag nodes to rearrange the graph. Scroll to zoom.</p>
